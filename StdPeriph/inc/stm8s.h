...
//#define STM8S103     /*!< STM8S Medium density devices */
#define STM8S105
...
/**
  ...
  */
  ...
  #define HSE_VALUE ((u32)8000000) //外部时钟 8MHz ,同上注释也可以在编译环境指定
#endif /* HSE_Value */

/**
  * @brief  Definition of Device on-chip RC oscillator frequencies
  */
#define HSI_VALUE   ((uint32_t)8000000)//((uint32_t)16000000) //外部时钟8MHz /*!< Typical Value of the HSI in Hz */
