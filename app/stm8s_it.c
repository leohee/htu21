...
/**
 ...
 INTERRUPT_HANDLER(UART2_TX_IRQHandler, 20)
 {
    ...
    */
    ...
    {
        if(gUart2.Tx_cnt<gUart2.Tx_len)
        {
            gUart2.TxFlag = SET;
        	...
        	UART2_SendData8(gUart2.TX_BUF[gUart2.Tx_cnt]);
...
/**
 ...
 INTERRUPT_HANDLER(UART2_RX_IRQHandler, 21)
 {
    ...
    */
    ...
    if(gUart2.Rx_cnt>RXTX_BUF_LEN)
    {
    	gUart2.Rx_cnt = 0;
    }
    gUart2.RX_BUF[gUart2.Rx_cnt++] = UART2_ReceiveData8();
    gUart2.RxFlag = SET;
    gUart2.ProcStatus = Status_RX_Receiving;

    switch(gUart2.Rx_cnt)
    {
        case 1:
            {
                if((gUart2.RX_BUF[0]!=gParam.add)
                    &&(gUart2.RX_BUF[0]!=0x00)
                    &&(gUart2.RX_BUF[0]!=0xFF))
                {
                    gUart2.Rx_cnt = 0;
                }
            }
        ...
        case 2:
            {
                if((gUart2.RX_BUF[1]!=FUNC_0x03)
                    &&(gUart2.RX_BUF[1]!=FUNC_0x04)
                    &&(gUart2.RX_BUF[1]!=FUNC_0x06))
                {
                    gUart2.Rx_cnt = 0;
                }
            }
